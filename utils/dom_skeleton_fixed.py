...
def create_dom_skeleton(full_html: str, max_depth: int = 15) -> str:
    """
    Takes a full HTML string and strips it down to a "skeleton"
    of interactive and structural elements.
    
    Args:
        full_html: The complete HTML content from the page
        max_depth: Maximum nesting depth to preserve (prevents overly deep structures)
    
    Returns:
        Clean, token-efficient HTML skeleton maintaining hierarchy
    """
    ...
    # STEP 1: Remove all the noise tags completely
    tags_to_remove = [
